 ...
 * @Descripition 使用FileWriter（字符流）向指定文件中写入数据
 * @Auther huangX
...
public class TestFileWriter {
    ...
    public static void main(String[] args) {
        ...
        try {
            fw = new FileWriter("C:\\Users\\Administrator\\Desktop\\writerTest.txt");
            //字符的本质是一个无符号的16位整数
            //字符在计算机内部占用2个字节
            ...
            long num = 0;
            FileReader fr = null;
            fr = new FileReader("C:\\Users\\Administrator\\Desktop\\writerTest.txt");
            while ((b = fr.read()) != -1) {
